 ...
 * under the License.
 */
package com.juancarlos.example;
...
public class LoginTest extends ConfigTest {
    ...
    public void testLoginConfig() {
        ActionConfig config = assertClass("/example", "Login_input", "com.juancarlos.example.Login");
    ...
    public void testLoginSubmitInput() throws Exception {
        ...
        assertFieldError(errors, "username", "Nombre de Usuario es requerido.");
        assertFieldError(errors, "password", "Contraseña es requerido.");
    }
